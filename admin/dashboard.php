...
if ($res) {
    while ($r = $res->fetch_assoc()) {
        ...
        // LOGIC: If DB sentiment is missing/neutral, calculate it from comment
        if (empty($dbSent) || strtolower($dbSent) === 'neutral') {
...
<head>
  ...
  <style>
    ...
    .badge-neutral { background:#7a7f85; color:#fff; }
